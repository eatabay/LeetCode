def superPowNaive(a, b):
    ...
    # 'p' == "power"
    # 'f' == "factor"
    for p,f in enumerate(b):
        exponent += f * (10**p)

    print(f'raising {a} to the {exponent}\'th power...')
    return (a**exponent) % 1337

a = 2
b = [2, 3]

# works for relatively small a & b[]; but,
# not for the a & b[] at the bottom of the file, for instance
print(superPowNaive(a,b))
